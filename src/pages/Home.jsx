...
export default function Home() {
  return (
    <Flex direction="column" align="center" justify="center" w="100%" p={4}>
      <Flex direction="column" w={{ base: "100%", md: "55%" }} align="center">
        {[
          {
          ...
          },
          {
            ...
            description:
              "Meer informatie over onze club vind je op deze website.",
          ...
          },
          {
            ...
            description:
              "Lindemans Aalst is een club met een rijke geschiedenis.",
